    ...
    <div className="theater-container py-12">
      ...
      <section className="theater-section">
        <div className="theater-section-header">
          ...
          <p className="theater-subtitle">
            Dégustez en avant-première les fruits de la recherche artistique et la collecte des réponses rédigées par des IA.
          </p>
        </div>
        ...
        <div className="theater-card-modern">
          ...
          <div className="border-l-4 border-solarized-base2 pl-6">
            ...
            <p className="theater-nav-description mb-4">
              Utilisation d&apos;outils de discussion avec les IA pour un raisonnement intégrant leurs idées et l&apos;analyse des concepts liés à l&apos;émergence de vie numérique dans le théâtre contemporain.
            </p>
            <Link 
      ...
      <section className="theater-section" aria-labelledby="qa-section-title">
        <div className="theater-section-header">
          ...
          <p className="theater-subtitle">
            Remise en question des concepts d&apos;aliénation et préfiguration de la mise en scène du spectacle à travers des conversations avec différents modèles d&apos;Intelligence Artificielle ayant eu lieu chez Duck.ai.
          </p>
        </div>
        <ResearchQA />
      </section>
