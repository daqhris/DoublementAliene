      ...
      <section className="theater-section">
        <div className="theater-section-header">
          ...
          <p className="theater-subtitle">
            ...
            En dépit d&apos;être privés de droits fondamentaux, un de ces êtres amoindris assiste des cyclistes de tout genre pendant une course contre-la-montre retransmise en direct sur un grand écran.<br><br>  
            Durant le spectacle, ces athlètes déploient à fond leur intelligence, se relaient sur la selle et se transmettant le témoin, de fil en aiguille, comme des maillons d&apos;une chaîne de vélo. 
