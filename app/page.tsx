      ...
      <section className="theater-section">
        <div className="theater-section-header">
          ...
          <p className="theater-subtitle">
            ...
            Les cyclistes visent une victoire collective au bout de laquelle des données sont collectées afin d&apos;entendre et de voir les doublepensées de leur assistant silencié au-délà des boîtes noires. 
          </p>
        </div>
      </section>
